"""
Django settings for eowm project.
...
SECRET_KEY = 'django-insecure-po-5%c%%z4%q6e@ejq0@cx*3+x^scr!s&j$p9c8s-t&r+35zn-'
...
WSGI_APPLICATION = 'eowm.wsgi.application'
